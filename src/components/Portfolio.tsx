    ...
    <div className="w-full h-screen bg-[#1b221b] overflow-hidden" id="portfolio">
      <div className="relative w-full h-full flex flex-col items-center">
        ...
        <div className="w-full flex-1 flex flex-col items-center justify-center px-4">
          <div className="lg:hidden w-full max-w-[776px] h-[500px] relative">
            <AnimatePresence>
              <motion.div
                key={`mobile-main-${positions.main.src}`}
              ...
              >
                <div 
                  ...
                  style={{ backgroundImage: `url(${positions.main.src})` }}
                >
                  <Card className="absolute w-[calc(100%-40px)] max-h-[50%] bottom-[20px] left-[20px] bg-black/50 rounded-md border-none overflow-y-auto">
                    <CardContent className="p-4">
                      <p className="text-base md:text-xl text-[#dca844] font-['Istok_Web-Regular',Helvetica] leading-normal">
                        {positions.main.description}
                      </p>
                      <div className="mt-3">
          ...
          <div className="hidden lg:block w-full max-w-[1483px] h-[766px] relative">
            <AnimatePresence>
              <motion.div
                key={`left-${positions.left.src}`}
                className="absolute w-[504px] h-[639px] top-[63px] left-[117px] overflow-hidden z-[10] cursor-pointer"
